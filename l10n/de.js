OC.L10N.register(
    ...
    "General": "Allgemein",
    "Enable or disable the TigerSprite PDF export functionality for Markdown files.": "Aktiviert oder deaktiviert die TigerSprite-PDF-Exportfunktion für Markdown-Dateien.",
    "Path to the PHP binary (e.g., /usr/bin/php or php).": "Pfad zur PHP-Binärdatei (z. B. /usr/bin/php oder php).",
    "Path to the TigerSprite CLI entry script (cli.php).": "Pfad zum TigerSprite-CLI-Einstiegsskript (cli.php).",
    "Choose the PDF generation engine. \"Auto\" will try wkhtmltopdf first, then fall back to dompdf.": "Wählen Sie die PDF-Erzeugungs-Engine. „Automatisch“ versucht zuerst wkhtmltopdf und fällt dann auf dompdf zurück.",
    "Whether to download the PDF directly or save it alongside the Markdown file.": "Legt fest, ob die PDF direkt heruntergeladen oder neben der Markdown-Datei gespeichert wird.",
    "Number of days to keep temporary conversion files before cleanup (0 = disable cleanup).": "Anzahl der Tage, die temporäre Konvertierungsdateien vor der Bereinigung aufbewahrt werden (0 = keine Bereinigung).",
    "Log detailed conversion information to the Nextcloud log for troubleshooting.": "Schreibt detaillierte Konvertierungsinformationen zur Fehlerbehebung in das Nextcloud-Protokoll.",
